...
export const CHARACTERS = {
  vespera: {
    level: 4,
    name: "Vespera", race: "Levistus Tiefling", class: "Divine Soul Sorcerer", img: PORTRAITS.vespera,
    ab: { STR: 8, DEX: 12, CON: 16, INT: 10, WIS: 10, CHA: 20 }, ac: 11, hp: 30,
    ...
    counters: [
      { name: "Hit Dice (d6)", max: 4, cur: 4, color: PIP_COLOR },
      { name: "Sorcery Points", max: 4, cur: 4, color: PIP_COLOR },
      { name: "Favored by the Gods (SR)", max: 1, cur: 1, color: PIP_COLOR },
      { name: "Legacy of Stygia (LR)", max: 1, cur: 1, color: PIP_COLOR },
      { name: "1st Level Slots", max: 4, cur: 4, color: PIP_COLOR },
      { name: "2nd Level Slots", max: 3, cur: 3, color: PIP_COLOR },
    ],
    inv: [{ id: "dagger", count: 2 }, "common_clothes", "rod", "locket", "antitoxin", "holy_water", "elixir_of_health", "lute", "gold_bracelet", "stirge_needle", "dwarven_beard_hair", "pouch", "ink", "small_knife", "wind_spore", "writing_quill", "backpack", "hempen_rope", { id: "rations", count: 3 }, "torch", "waterskin", { id: "book", titleOverride: "Diary" }, { id: "paper", count: 10 }, "scroll_case", { id: "spell_scroll", titleOverride: "Scroll of Command" }],
    feat: ["spellcasting_sorcerer", "divine_magic", "favored_by_the_gods", "font_of_magic", "sorcery_points", "flexible_casting", "metamagic", "metamagic_quickened_spell", "metamagic_twinned_spell", "sorcerous_versatility", "age_tiefling", "darkvision_tiefling", "hellish_resistance", "legacy_of_stygia", "researcher"],
    spells: ["frostbite", "guidance", "light", "prestidigitation", "ray_of_frost", "spare_the_dying", { id: "armor_of_agathys", footerOverride: "Legacy of Stygia" }, { id: "command", footerOverride: "Scroll of Command" }, "guiding_bolt", "healing_word", { id: "protection_from_evil_and_good", footerOverride: "Divine Magic · Concentration" }, "shield", "aid", "enhance_ability"],
  },
  lucia: {
    level: 6,
